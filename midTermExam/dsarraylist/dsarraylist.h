 ...
 * or @ref arraylist_removeRange.
 */

#ifndef DSARRAYLIST_H
#define DSARRAYLIST_H
 ...
 *
 * @param arraylist      The ArrayList.
 * @param compareFunc   Function used to compare values in sorting.
 */
