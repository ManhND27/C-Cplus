 ...
 *
 * To find the number of entries in a set, use @ref set_numEntries.
 *
 ...
 * a @ref SetIterator structure, with @ref set_iteratorNext and
 * @ref set_iteratorHasMore to read each value in turn.
 *
 ...
 * Create a new set.
 *
 * @param hashFunc      Hash function used on values in the set.
 * @param equalFunc     Compares two values in the set to determine
 *                      if they are equal.
 ...
 *
 * @param set           The set.
 * @param freeFunc      Function to call when values are removed from the
 *                      set.
 */
